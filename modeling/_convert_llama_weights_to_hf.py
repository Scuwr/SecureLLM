...
# 
# To convert llama weights provided by meta to hugingface format
# 
# https://raw.githubusercontent.com/huggingface/transformers/main/src/transformers/models/llama/convert_llama_weights_to_hf.py
# 
# 
# 
...
def main():
    ...
    spm_path = os.path.join(args.tokenizer_dir, "tokenizer.model")
